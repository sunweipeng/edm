...
'乾', '坤']
class RandomUserNameHelper(object):
	"""
	随机生成名字
	"""
	@staticmethod
	def get_user_name():
		"""first name"""
		first_list = random.sample(FIRST_NAME, 1)
		"""last name"""
		LAST_NAME_LENGTH = random.randint(1, 2)
		last_list = random.sample(LAST_NAME, LAST_NAME_LENGTH)
		first_list += last_list
		return "".join(first_list)


if __name__ == "__main__":
	userName = RandomUserNameHelper.get_user_name()
	print(userName)
